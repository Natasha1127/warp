...
function C(
  ...
  return { body, explanation, hint, choices: makeChoices(correct, distractors) };
}
  ...
  // ════ 1年生 ════
  {
    ...
    units: [
      simpleUnit("g1-u1", "なかまづくりとかず", 1,
        [
          C("○が ●●● あります。いくつ？", "3", ["2", "4", "5"], "●が3こなので 3です。", "ひとつずつ かぞえよう。"),
      ...
      simpleUnit("g1-u2", "なんばんめ", 2,
        [
          ...
          C("左から2番目はどれ？〔★☆●◆〕", "☆", ["★", "●", "◆"], "左から数えて2つ目は☆です。", "左のはしから かぞえよう。"),
          C("前から4番目の前には何人いる？", "3", ["4", "2", "5"], "4番目の前には3人います。", ""),
        ],
        [
          C("右から1番目はどれ？〔★☆●◆〕", "◆", ["●", "☆", "★"], "右のはしは◆です。", "右から かぞえよう。"),
      ...
      simpleUnit("g1-u6", "わかりやすくせいりしよう", 6,
        [
          C("くだものを数えた絵グラフ。一番多いのは高さがどう？", "一番高い", ["一番低い", "まんなか", "関係ない"], "多いほど高くなります。", ""),
          C("りんご3こ、みかん5こ。多いのは？", "みかん", ["りんご", "同じ", "なし"], "5>3でみかん。", ""),
          C("グラフでぼうが短いのは数が？", "少ない", ["多い", "同じ", "ゼロ"], "短い=少ないです。", ""),
        ],
        [
          C("りんご4・みかん6・ばなな2。一番少ないのは？", "ばなな", ["りんご", "みかん", "同じ"], "2が一番少ない。", ""),
          C("赤5・青3。ちがいは？", "2", ["1", "3", "8"], "5-3=2です。", ""),
          C("3種類で 4+2+5。全部で何こ？", "11", ["10", "12", "9"], "4+2+5=11です。", ""),
        ],
        [
          C("ねこ7・いぬ4・うさぎ5。多い順の2番目は？", "うさぎ", ["ねこ", "いぬ", "同じ"], "7>5>4で2番目はうさぎ。", ""),
      ...
      simpleUnit("g1-u8", "なんじなんじはん", 8,
        [
          C("長いはりが12、みじかいはりが3。何時？", "3時", ["3時半", "12時", "4時"], "長い針が12ちょうどで3時です。", ""),
          C("「○時半」のとき長いはりはどこ？", "6", ["12", "3", "9"], "半は長い針が6です。", ""),
          C("みじかいはりが指す数は何を表す？", "何時", ["何分", "何秒", "何日"], "短い針は「時」を表します。", ""),
        ],
        [
          C("長い6・短い7と8の間。何時何分？", "7時半", ["8時半", "6時", "7時"], "短針が7と8の間で長針6は7時半。", ""),
    ...
    units: [
      simpleUnit("g2-u1", "ひょうとグラフ", 1,
        [
          ...
          C("赤6・青4。多いのは？", "赤", ["青", "同じ", "なし"], "6>4で赤。", ""),
          C("表で数を表すとき書くのは？", "数字", ["絵だけ", "色だけ", "なにも"], "表には数字を書きます。", ""),
        ],
        [
          C("犬5・猫8・鳥3。一番多いのは？", "猫", ["犬", "鳥", "同じ"], "8が最大。", ""),
